...
client = commands.Bot(command_prefix= '<@1010540262298222652>' )
...
async def spam():
    ...
    await channel.send(''.join(random.sample(string.ascii_letters+string.digits,10)*5))
...
print(f'Pokétwo Autocatcher {version} is running!')
